...
public class BitVector extends Datatype {
    ...
    /**
     * Creates a new bit vector. At default the most significant bit of values
     * has the greatest index. If an array with the reversed order is given, the
     * parameter reversed has to be true.
     *
     * @param kind <b>EKind</b> datatype kind
     * @param variablename <b>String</b> name of this variable
     * @param reversed <b>boolean</b> value indices are reversed
     * @param values <b>bolean[]</b> values
     */
     ...
     * @param variablename <b>String</b> name of this variable
     * @param reversed <b>boolean</b> value indices are reversed
     * @param length <b>int</b> size of the vector
     */
